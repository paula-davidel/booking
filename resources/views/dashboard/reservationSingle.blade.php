        ...
        <div class="card-body">
            <div class="card-body">
                ...
                <div class="text-center mt-3">
                    <a href="{{url('/dashboard/reservations/{{ $reservation->id }}/edit')}}" class="btn btn-lg btn-success">Edit this reservation</a>
                    <a href="{{url('/dashboard/reservations/{{ $reservation->id }}/delete')}}" class="btn btn-lg btn-danger">Delete</a>
                </div>
            </div>          
        </div>
    </div>
